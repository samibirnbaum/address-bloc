...
RSpec.describe "AddressBook" do
    ...
    describe "#iterative_search" do
        it "searches address book for non existent entry" do
            book.import_from_csv("entries.csv") #5 entries exist
            entry = book.iterative_search("Sami") #this is not one of the entrys
            expect(entry).to be_nil
        end

        it "search address book for Bill" do
            book.import_from_csv("entries.csv")
        ...
        it "search address book for Bob" do
            book.import_from_csv("entries.csv")
        ...
        it "search address book for Joe" do
            book.import_from_csv("entries.csv")
        ...
        it "search address book for Sally" do
            book.import_from_csv("entries.csv")
        ...
        it "search address book for Sussie" do
            book.import_from_csv("entries.csv")
